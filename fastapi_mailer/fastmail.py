...
from fastapi_mailer.connection import Connection
from fastapi_mailer.errors import PydanticClassRequired
from fastapi_mailer.msg import MailMsg
from fastapi_mailer.schemas import MessageSchema
